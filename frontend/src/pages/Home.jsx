...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>RASS Engineering | Waterproofing & Structural Experts</title>
        <meta
          name="description"
          content="RASS Engineering & Construction Pvt. Ltd. offers professional waterproofing, structural retrofitting, epoxy flooring and specialized construction solutions with 31+ years of expertise."
        />
                  ...
                  <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md p-6 rounded-xl shadow-lg">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">ISO Certified Services</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  From waterproofing to structural retrofitting, we combine advanced technologies with
                  time-tested engineering principles to deliver exceptional results that stand the test of time.
                </p>
                <Link to="/about">
