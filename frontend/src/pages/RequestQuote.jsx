  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Request a free quote for your construction project. Get professional estimates for waterproofing, structural retrofitting, and specialized engineering services."
        />
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        >
                          ...
                          <option value="cement-grouting">Cement Pressure Grouting</option>
                          <option value="expansion-joint">Expansion Joint Treatment</option>
                          <option value="structural-retrofitting">Structural Retrofitting</option>
                          <option value="anti-termite">Anti-Termite Treatment</option>
                          <option value="epoxy-flooring">Epoxy & PU Flooring</option>
                          <option value="acp-cladding">ACP & HPL Cladding</option>
                          <option value="structural-glazing">Structural Glazing</option>
                          <option value="metal-truss">Metal Truss & Canopy</option>
