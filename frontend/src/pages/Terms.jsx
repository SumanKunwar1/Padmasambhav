              ...
              <div className="space-y-8 text-gray-600">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Epoxy and PU flooring</li>
                    <li>ACP and HPL cladding</li>
                    <li>Structural glazing and aluminum works</li>
                    <li>Metal truss and canopy fabrication</li>
                    <li>Other specialized construction services</li>
                  </ul>
                </div>
